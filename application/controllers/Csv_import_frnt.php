           ...
           //For Excel Upload
            ...
            if(!empty($_FILES['csv_file']['name']) && in_array($_FILES['csv_file']['type'],$csvMimes)){
                ...
                $csvFile = fopen($_FILES['csv_file']['tmp_name'], 'r');
				  ...
				  'dmd_frm_fin_yr'			 =>	$line[2],
				  'dmd_to_fin_yr'			 =>	$line[3],
				  'dmd_prn_od'			     =>	$line[4],
				  'dmd_prn_cr'			     =>	$line[5],
				  'dmd_prn_tot'			     =>	$line[6],
				  'dmd_int_od'	             =>	$line[7],
				  ...
				  'tot_colc'			     =>	$line[18],
				  'recov_per'			     =>	$line[19],
				  'prv_yr_dmd_prn'	         =>	$line[20],
				  'prv_yr_dmd_int'           =>	$line[21],
				  'prv_yr_dmd_tot' 	         =>	$line[22],
				  'prv_yr_col_prn'			 =>	$line[23],
				  'prv_yr_col_int'	         =>	$line[24],
				  'prv_yr_col_tot'           =>	$line[25],
				  'col_per' 	             =>	$line[26],
				  'tot_no_ac_dmd'	         =>	$line[27],
				  'tot_no_ac_od_dmd'		 =>	$line[28],
				  'tot_no_ac_curr_dmd'		 =>	$line[29],
				  'tot_no_ac_col'			 =>	$line[30],
				  'tot_no_ac_od_col'		 =>	$line[31],
				  'tot_no_ac_curr_col'	     =>	$line[32],
				  'tot_no_ac_prog'           =>	$line[33],
				  'tot_no_ac_od_prog' 	     =>	$line[34],
				  'tot_no_ac_curr_prog'      => $line[35],

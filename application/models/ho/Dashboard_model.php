...
class Dashboard_Model extends CI_Model {
    ...
    function get_shg_dc_details() {
        $this->db->select('ardb_id, entry_date, memo_no, ho_fwd_data, ho_approve_1, ho_approve_2, document_flag');
        $this->db->where(array(
            'fwd_data' => 'Y',
            'approve_1' => 'Y',
            'approve_2' => 'Y'
        ));
        $this->db->group_by('memo_no, ardb_id,entry_date,ho_fwd_data, ho_approve_1, ho_approve_2, document_flag');
    ...
    function get_shg_apex_dc_details() {
        $this->db->select('ardb_id, memo_date as entry_date, memo_no, ho_fwd_data, ho_approve_1, ho_approve_2, document_flag');
        $this->db->where(array(
            'fwd_data' => 'Y',
            'approve_1' => 'Y',
            'approve_2' => 'Y'
        ));
        $this->db->group_by('memo_no, ardb_id,memo_date,ho_fwd_data, ho_approve_1, ho_approve_2, document_flag');

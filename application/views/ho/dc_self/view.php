...
<div class="main-panel">
	...
	<?= form_open('ho/dc_self'); ?>
	<div class="card">
            <div class="card-body">
		<h4 class="card-title"> <b>DC Details</b> <small>Other Than SHG</small>
	...
	<?php if (isset($_REQUEST['search'])) { ?>
    	...
    	<div class="card" style="margin-top:25px;">
    	    <div class="card-body">
    		<center><h4 class="card-title" style="color:green;"> <b>OTHER THAN SHG DC DETAILS</b> <small></small>
    		...
    		<div class="row">
    			...
    			<div class="table-responsive">
					...
					foreach ($shg_details as $dt) {
					    ...
					    echo '<td>
                                        <a href="dc_self/dc_entry/' . $dt->ardb_id . '/' . $pronote_no . '/' . $memo_no . '" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil fa-lg"></i></a>';
					    if ($dt->fwd_data == 'N') {

...
<div class="main-panel">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-12">
                        ...
                        <div style="text-align: center;">
                            <?php
                            $fwd_data = $_SESSION['user_type'] == 'P' ? $friday_details[0]->ho_approve_1 : ($_SESSION['user_type'] == 'V' ? $friday_details[0]->ho_approve_2 : '');
                            if ($fwd_data != 'Y') {
                                ?>
    ...
    <script>
        function forward() {
            window.location.href = "<?= site_url('/ho/friday_return/forward/' . $friday_details[0]->ardb_id . '?dt=' . $friday_details[0]->week_dt); ?>";
        }
        function reject() {
            window.location.href = "<?= site_url('/ho/friday_return/reject/' . $friday_details[0]->ardb_id . '?dt=' . $friday_details[0]->week_dt); ?>";
        }
    </script>
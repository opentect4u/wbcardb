...
<div class="main-panel">
	...
	<?= form_open('ho/apex_shg/apex_shg_view'); ?>
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"> <b>APEX DC Details</b> <small>Self SHG</small>
	...
	<?php if (isset($_REQUEST['search'])) { ?>
    	...
    	<div class="card" style="margin-top:25px;">
    	    <div class="card-body">
    		<center><h4 class="card-title" style="color:green;"> <b>SHG APEX DC DETAILS</b> <small></small>
...
//                                            echo '<td>' . $dt->file_no . '</td>';
					    echo '<td><a href="apex_shg_entry/' . $dt->ardb_id . '/' . $pronote_no . '/' . $memo_no . '" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil fa-lg"></i></a>';
					    if ($dt->fwd_data != 'Y') {
						echo '<a href="apex_shg/dc_delete/' . $pronote_no . '/' . $memo_no . '" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return check();"><i class="fa fa-trash-o fa-lg" style="color:red"></i></a>';
					    }
					    echo '</tr>';
					}
					?>

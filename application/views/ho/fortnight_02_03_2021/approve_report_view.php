                                    ...
                                    <tbody>
                                        ...
                                        if ($report_details) {
                                            ...
                                            foreach ($report_details as $dt) {
                                                ...
                                                echo '<td>' . $status . '</td>';
                                                echo '<td><a href="report_view_details/' . $dt->ardb_id . '?dt=' . $dt->return_dt . '" data-toggle="tooltip" data-placement="bottom" title="View"><i class="fa fa-eye fa-lg" aria-hidden="true"></i></a></td>';
                                                echo '</tr>';
                                                $i++;
                                            }
                                        }

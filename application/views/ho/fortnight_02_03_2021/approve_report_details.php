                    ...
                    <div class="col-12">
                        <div id="divToPrint" style="overflow-x:auto;">
                            <h4><center>FORTNIGHTLY RETURN<br>
                                    ...
                                    <p><?php //'Form: ' . $form_date . ' To: ' . $to_date                           ?></p>
                                </center></h4>
...
//                            $fwd_data = $_SESSION['user_type'] == 'P' ? $report_details[0]->fwd_data : ($_SESSION['user_type'] == 'V' ? $report_details[0]->fwd_data : '');
        ...
        <script>
            function forward() {
                window.location.href = "<?= site_url('/ho/fortnight/report_forward/' . $report_details[0]->ardb_id . '?dt=' . $report_details[0]->return_dt . '&sec='); ?>";
            }
            function reject() {
                window.location.href = "<?= site_url('/ho/fortnight/report_reject/' . $report_details[0]->ardb_id . '?dt=' . $report_details[0]->return_dt . '&sec='); ?>";
            }
        </script>

...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <script>
            function forward() {
                window.location.href = "<?= site_url('/ho/fortnight/forward/' . $fortnight_details[0]->ardb_id . '?fr=' . $fortnight_details[0]->return_form . '&to=' . $fortnight_details[0]->return_to); ?>";
            }
            function reject() {
                window.location.href = "<?= site_url('/ho/fortnight/reject/' . $fortnight_details[0]->ardb_id . '?fr=' . $fortnight_details[0]->return_form . '&to=' . $fortnight_details[0]->return_to); ?>";
            }
        </script>
...
$sector = unserialize(LOAN_ISSUE_SECTOR);
$header = ucwords(strtolower($sector[$sector_id])) . ' Sector';
$no_of_case = $sector_id == 1 ? 'fm_no_case' : ($sector_id == 2 ? 'nf_no_case' : ($sector_id == 3 ? 'rh_no_case' : ($sector_id == 4 ? 'shg_no_case' : 'pl_no_case')));
$amt = $sector_id == 1 ? 'fm_amt' : ($sector_id == 2 ? 'nf_amt' : ($sector_id == 3 ? 'rh_amt' : ($sector_id == 4 ? 'shg_amt' : 'pl_amt')));
?>
<style>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div id="divToPrint" style="overflow-x:auto;">
                            ...
                            <h5 class="mt-4"><center><u>Position of Investment at PCARDB Level (<?= $header ?>)</u><br>
                                    <p>Rs. In Lakh</p>
                                </center></h5>
                            <table style="width: 100%;" id="example">
                                <thead>
                                    <tr>
                                        <th rowspan="2">#</th>
                                        <th rowspan="2">Name of ARDBs &<br>Branches</th>
                                        <th rowspan="2">Return Form</th>
                                        <th rowspan="2">Return To</th>
                                        <th colspan="2"><?= $header ?></th>
                                        <th colspan="2">Total Investment of the Year <?= CURRENT_YEAR . '-' . date('y', strtotime(NEXT_YEAR)) ?></th>
                                    </tr>
                                    <tr>
                                        <th>No of Case</th>
                                        <th>Amount</th>
                                ...
                                <tbody>
                                    ...
                                    if ($fortnight_details) {
                                        ...
                                        foreach ($fortnight_details as $dt) {
                                            ...
                                            echo '<td>' . $dt->$no_of_case / $lkh . '</td>';
                                            echo '<td>' . $dt->$amt / $lkh . '</td>';

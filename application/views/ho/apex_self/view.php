...
<div class="main-panel">
	...
	<?= form_open('ho/apex_self/apex_self_view'); ?>
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"> <b>APEX DC Details</b> <small>Other Than SHG</small>
	...
	<?php if (isset($_REQUEST['search'])) { ?>
    	...
    	<div class="card" style="margin-top:25px;">
    	    <div class="card-body">
    		<center><h4 class="card-title" style="color:green;"> <b>OTHER THAN SHG APEX DC DETAILS</b> <small></small>
...
//                                            echo '<td>' . $dt->file_no . '</td>';
					    echo '<td><a href="apex_self_entry/' . $dt->ardb_id . '/' . $pronote_no . '/' . $memo_no . '" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil fa-lg"></i></a>';
					    if ($dt->fwd_data != 'Y') {
						echo '<a href="apex_self/dc_delete/' . $pronote_no . '/' . $memo_no . '" data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return check();"><i class="fa fa-trash-o fa-lg" style="color:red"></i></a>';
					    }
					    echo '</tr>';
					}
					?>

...
<div class="main-panel">
    <div class="content-wrapper">
		...
		<?= form_open('ho/apex_self/apex_self_save'); ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-header">
                            <h4 class="mb-4">APEX DC Entry Form <small>Other Than SHG</small></h4> <hr>
                        </div>
...
//                                    echo'<td><button type="button" id="remove_' . $i . '" class="btn btn-danger" onclick="_delete(' . $i . ')"><i class="fa fa-remove"></i></button></td>';
	...
	$('#dynamic_add').click(function () {
	    ...
	    if (x < count) {
		if ($('#pronote_no_' + x).val() != '' && $('#lso_no_' + x).val() != '') {
		    x++;
		    $('#table').append('<tr id="row_' + x + '">'
			    + '<td><div class="form-group"><input type="text" class="form-control" name="pronote_no[]" id="pronote_no_' + x + '" value="" required="" /></div></td>'
			    ...
			    + '<td><div class="form-group"><input type="text" class="form-control required" name="shg_name[]" id="shg_name_' + x + '" value="" /></div></td>'

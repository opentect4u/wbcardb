...
<div class="main-panel">
	...
	<?= form_open('ho/apex_self/apex_self_approve_view'); ?>
        <div class="card">
            <div class="card-body">
...
//                                        echo '<td>' . $dt->sector_name . '</td>';
						...
						if ($_SESSION['user_type'] == 'U') {
						    ...
						    echo 'Forwaded to APEX Banking';
						}
					    } else {
						echo '';
					    }
					    echo '</td>';
					    echo '<td><a href="approve_details/' . $approve_details[0]->ardb_id . '/' . $memo_no . '" data-toggle="tooltip" data-placement="bottom" title="View"><i class="fa fa-eye fa-lg"></i></a></td>';
					    echo '</tr>';
					    $i++;
					}
					?>

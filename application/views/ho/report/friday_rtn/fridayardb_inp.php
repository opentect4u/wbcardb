<div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            ...
            <div class="card-body">
                  <h4 style="color:blue">Please Input</h4>
                  
             <div class="row">
                <div class="col-12">
              
              <form method="POST" id="form" action="<?php echo site_url("ho/Report/friday_ardb");?>" >
                    ...
                    <div class="form-group row">
                        <label for="to_dt" class="col-sm-2 col-form-label">ARBD:</label>

                         <div class="col-sm-4">
                              <select class="form-control" name="ardb_id">

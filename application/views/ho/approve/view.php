<?php
 ...
 <div class="main-panel">
        <div class="content-wrapper">
          <?= form_open('ho/approve/forward/' . $flag); ?>
          <div class="card">
            <div class="card-body">
              <h4 class="card-title"> <b>SELECT SHG</b> <small></small>
                <span class="confirm-div" style="float:right;"><?php echo $this->session->flashdata('msg'); ?></span></h4>
              <div class="row">
                <div class="col-md-6">
        ...
        <?php if(isset($_REQUEST['search'])){ ?>
          ...
          <div class="card" style="margin-top:25px;">
            <div class="card-body">
              <center><h4 class="card-title" style="color:green;"> <b>SHG DC DETAILS</b> <small></small>
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       <?php foreach($shg_details as $dt){
                                ...
                                echo '<td>
                                        <a href="'.base_url().'index.php/ho/approve/dc_entry/' . $dt->ardb_id . '/'.$pronote_no.'/'.$memo_no.'" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil fa-lg"></i></a>
                                  </td>';
                                  if($dt->upload > 0){
                                    echo '<td>
                                        <a href="'.base_url().'index.php/ho/dc/download_zip/'.$dt->ardb_id.'/'.$pronote_no.'" data-toggle="tooltip" data-placement="bottom" title="Download"><i class="fa fa-download fa-lg"></i></a>
                                        </td>';
                                        if($dt->fwd_data == 'N'){
                                    echo '<td>
                                      <a href="'.base_url().'index.php/ho/approve/forward_data/' . $flag . '/' . $dt->ardb_id . '/' .$pronote_no.'/'.$memo_no.'" data-toggle="tooltip" data-placement="bottom" title="Forward Data"><i class="fa fa-forward fa-lg"></i></a>
                                      </td>';
                                    }else{
                                      echo '<td></td>';
                                    }

...
<div class="main-panel">
    <div class="content-wrapper">
        <?= form_open('ho/apx_dc_approve/apex_view/' . $flag_name); ?>
        <div class="card">
            <div class="card-body">
        ...
        <?php if (isset($_REQUEST['search'])) { ?>
            ...
            <div class="card" style="margin-top:25px;">
                <div class="card-body">
                    <center><h4 class="card-title" style="color:green;"> <b>APEX <?= $flag > 0 ? 'OTHER THAN SHG' : 'SELF SHG' ?> DC DETAILS</b> <small></small>
                        </h4></center><hr>
                    <div class="row mt-4">
                        <div class="col-12">
...
//                                        echo '<td>' . $dt->sector_name . '</td>';
                                            echo '<td><a href="' . site_url() . '/ho/apx_dc_approve/apex_entry/' . $flag . '/' . $dt->ardb_id . '/' . $memo_no . '" data-toggle="tooltip" data-placement="bottom" title="View"><i class="fa fa-eye fa-lg"></i></a></td>';
                                            echo '</tr>';
                                            $i++;
                                        }
                                        ?>

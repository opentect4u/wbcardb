                  ...
                  <div class="card-body">
                    ...
                    <form class="form-sample" method="POST" id="purchase_form" action="<?php echo site_url('Sales/addsales'); ?>">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Bill dt.</label>
                            <div class="col-sm-9">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">IN OUT TYPE.</label>
                            <div class="col-sm-9">
  ...
  $(document).ready(function(){
    ...
    //  row.find('td:eq(1) select').on("change", function(){
            $( document ).ajaxComplete(function() {
              ...
              $.get('<?php echo site_url("Sales/js_get_expiryasbatchSelection");?>',{ Batch: BatchVal })
              .done(function(data)
              {
    ...
    <script> 
        $(document).ready(function() { 
          ...
          $('.table tbody').on('keyup', '.qty', function(){
            ...
            // alert(qty);
           // netPrice =parseFloat(netPrice *qty- Dis_Amount).toFixed('2');
           netPrice =parseFloat(netPrice *qty- tot_dis_amt).toFixed('2');
  ...
  var WindowObject = window.open('','Print-Window');
    ...
    (day<10 ? '0' : '') + day;
                    ...
                    if(new Date(output) < new Date(trans_dt)){
                      ...
                      alert("Sale  Date Can Not Be Greater Than Current Date");

                      ...
                      ?>
                        <tr>
                            ...
                            <td><?php echo $i; ?></td>
                             ...
                             <td><?php echo $row->bill_dt;?></td>
                              <td><?php echo $row->cust_name;?></td>
                              <td><?php echo round($row->tot_amt,0);?></td> 
                            <td>
                              <a href="<?php echo site_url('Sales/viewReport?bill_no='.$row->bill_no.''); ?>" title="Print"><i class="fa fa-print" aria-hidden="true"></i>Print</a>
                            </td>
                            <td>
                              ...
                              <span class="mdi mdi-delete"></span>
                                    ...
                                    <a href="http://localhost/pharmacy/index.php/Purchases/editPurchase?id=ICC-3053" title="Edit"><i class="mdi mdi-pencil-box-outline"></i></a>
                            </td>  
                        </tr>
                         <?php 
                          $i++;

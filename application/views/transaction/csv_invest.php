        ...
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
                ...
                <div class="row">
   <div class="col-md-10"> <h2 style="color:#4CAF50">Fortnightly Investment</h2> </div>
                  <div class="col-md-2">
             <a href="<?=base_url()?>index.php/csv_import/upload_invest"> <button type="button" class="btn btn-primary" style="float:left;">Upload File</button></a>
            </div>
            </div>
          </br>

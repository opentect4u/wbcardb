                                                ...
                                                <div class="collapse" id="li-fwd" aria-expanded="false">
                                                    <ul class="nav flex-column sub-menu">
                                                        ...
                                                        <?php } elseif ($_SESSION['user_type'] == 'V' || $_SESSION['user_type'] == 'A') { ?>
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" href="<?php echo site_url('ho/fortnight/report_inv_in/0'); ?>">Report</a></li>
                                                            <!--<li class="nav-item"><a class="nav-link" href="<?php // echo site_url('ho/fortnight/report_inv_in/1');          ?>">Consolidated</a></li>-->
                                                        <?php } ?>
                                                    </ul>
                                                </div>
                                            </li>

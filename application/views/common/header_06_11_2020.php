           ...
           <li class="nav-item <?php if($this->uri->segment(1) == "csv_import" OR "csv_import_frnt") {
            ...
            <div class="collapse" id="ui-advanced">
              ...
              <li class="nav-item"><a class="nav-link" href="<?php echo site_url('csv_import/frt_borrow_clas');?>">Borrower's Classification </a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo site_url('csv_import_frnt');?>">FortnFortnightlyightly Return </a></li>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-dc" aria-expanded="false" aria-controls="ui-dc">
              <i class="mdi mdi-layers menu-icon"></i>
              <span class="menu-title">DC </span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-dc">
              <ul class="nav flex-column sub-menu">
                <!-- <li class="nav-item"> <a class="nav-link" href="<?php //echo site_url('ho/report/fortnightly_ho');?>">Ho</a></li> -->
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('ho/report/dc_ardb');?>">Branch</a></li>
              </ul>
            </div>
          </li>

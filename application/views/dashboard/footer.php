<footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <!-- <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2018 Synergic Softek Solutions Pvt.Ltd.<a href="https://www.synergicsoftek.in/"></a>. All rights reserved.</span> -->

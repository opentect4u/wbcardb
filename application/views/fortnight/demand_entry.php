...
<div class="main-panel">
                                ...
                                <div class="table-responsive margin-topp-remove">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Principal</td>
                                                <td><div class="form-group"><input type="decimal" class="form-control" name="pri_od" id="pri_od" value="<?= $selected ? $selected->pri_od : '0' ?>" required="" /></div></td>
                                                <td><div class="form-group"><input type="decimal" class="form-control" name="pri_cr" id="pri_cr" value="<?= $selected ? $selected->pri_cr : '0' ?>" required="" /></div></td>
                                                <td colspan="2"><div class="form-group"><input type="decimal" class="form-control" name="pri_tot" id="pri_tot" value="<?= $selected ? $selected->pri_tot : '0' ?>" required="" readonly/></div></td>
                                            </tr>
                                            <tr>
                                                <td>Interest</td>
                                                <td><div class="form-group"><input type="decimal" class="form-control" name="int_od" id="int_od" value="<?= $selected ? $selected->int_od : '0' ?>" required="" /></div></td>
                                                <td><div class="form-group"><input type="decimal" class="form-control" name="int_cr" id="int_cr" value="<?= $selected ? $selected->int_cr : '0' ?>" required="" /></div></td>
                                                <td colspan="2"><div class="form-group"><input type="decimal" class="form-control" name="int_tot" id="int_tot" value="<?= $selected ? $selected->int_tot : '0' ?>" required="" readonly/></div></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center" colspan="3">Total Demand</td>
                                                <td colspan="2"><div class="form-group"><input type="decimal" class="form-control" name="tot_dmd" id="tot_dmd" value="<?= $selected ? $selected->tot_dmd : '0' ?>" required="" readonly/></div></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
    ...
    <script>
        ...
        function dmd_prn_tot() {
            var count = parseFloat($('#pri_od').val()) + parseFloat($('#pri_cr').val());
            $('#pri_tot').val(count);
        }
...
/////////
        ...
        function dmd_int_tot() {
            var count = parseFloat($('#int_od').val()) + parseFloat($('#int_cr').val());
            $('#int_tot').val(count);
        }

        function tot_dmd() {
            var count = parseFloat($('#pri_tot').val()) + parseFloat($('#int_tot').val());
            $('#tot_dmd').val(count);
        }
    </script>
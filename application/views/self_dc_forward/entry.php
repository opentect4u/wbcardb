    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                ...
                <?= form_open('dc_self_forward/dc_save'); ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-header">
                    <h4>DC Self Form Entry</h4>
                    </div>
                              ...
                              <?php 
                                if(sizeof($dc_shg_dtls) > 0){
                                  ...
                                  foreach($dc_shg_dtls as $dt){
                                    ...
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="brrwr_sl_no[]" id="brrwr_sl_no_'.$i.'" value="'.$dt->brrwr_sl_no.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="rate_of_interest[]" id="rate_of_interest_'.$i.'" value="'.$dt->roi.'" /></div> 
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                      <div class="form-group">
                                        <select class="form-control" id="sanction_block_id_'.$i.'" name="sanction_block_id[]" required >
                                          <option value="">Select</option>';
                                          if($block_list){
                                            foreach($block_list as $block){
                                              $select = "";
                                              if($dt->sanc_block_id == $block->block_code){
                                                $select = "selected";
                                              }
                                    ...
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="sanction_working[]" id="sanction_working_'.$i.'" value="'.$dt->sanc_working.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="sanction_total[]" id="sanction_total_'.$i.'" value="'.$dt->sanc_total.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group">
                                        <select class="form-control" id="disbursement_block_id_'.$i.'" name="disbursement_block_id[]" required >
                                          <option value="">Select</option>';
                                          if($block_list){
                                            foreach($block_list as $block){
                                              $select = "";
                                              if($dt->dis_block_id == $block->block_code){
                                                $select = "selected";
                                              }
                                              echo '<option value="'.$block->block_code.'" '.$select.'>'.$block->block_name.'</option>';
                                            }
                                    ...
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="disbursement_working[]" id="disbursement_working_'.$i.'" value="'.$dt->dis_working.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="disbursement_total[]" id="disbursement_total_'.$i.'" value="'.$dt->dis_total.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="own_contribution[]" id="own_contribution_'.$i.'" value="'.$dt->own_cont.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="subsidy_received[]" id="subsidy_received_'.$i.'" value="'.$dt->sub_received.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="subsidy_receivable[]" id="subsidy_receivable_'.$i.'" value="'.$dt->sub_receivable.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="total_loan_amount[]" id="total_loan_amount_'.$i.'" value="'.$dt->tot_loan_amt.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="lof_mortgage[]" id="lof_mortgage_'.$i.'" value="'.$dt->lof_mort.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="af_cultivation[]" id="af_cultivation_'.$i.'" value="'.$dt->af_culti.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="security_land[]" id="security_land_'.$i.'" value="'.$dt->sec_land.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="security_other[]" id="security_other_'.$i.'" value="'.$dt->sec_oth.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="security_total[]" id="security_total_'.$i.'" value="'.$dt->sec_tot.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="igo_loan[]" id="igo_loan_'.$i.'" value="'.$dt->igo_loan.'" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="tg_bond[]" id="tg_bond_'.$i.'" value="'.$dt->tot_mordg_bond.'" /></div> 
                                    </td>
                                  ...
                                  <tr id="row_1">
                                    ...
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="brrwr_sl_no[]" id="brrwr_sl_no_1" value="" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="rate_of_interest[]" id="rate_of_interest_1" value="" /></div> 
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                      <div class="form-group">
                                        <select class="form-control" id="sanction_block_id_1" name="sanction_block_id[]" required >
                                          <option value="">Select</option>
                                          <?php if($block_list){
                                            foreach($block_list as $block){
                                    ...
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="sanction_working[]" id="sanction_working_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="sanction_total[]" id="sanction_total_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group">
                                        <select class="form-control" id="disbursement_block_id_1" name="disbursement_block_id[]" required >
                                          <option value="">Select</option>
                                          <?php if($block_list){
                                            foreach($block_list as $block){
                                              echo '<option value="'.$block->block_code.'">'.$block->block_name.'</option>';
                                    ...
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="disbursement_working[]" id="disbursement_working_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="disbursement_total[]" id="disbursement_total_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="own_contribution[]" id="own_contribution_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="subsidy_received[]" id="subsidy_received_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="subsidy_receivable[]" id="subsidy_receivable_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="total_loan_amount[]" id="total_loan_amount_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="lof_mortgage[]" id="lof_mortgage_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="af_cultivation[]" id="af_cultivation_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="security_land[]" id="security_land_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="security_other[]" id="security_other_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="security_total[]" id="security_total_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="igo_loan[]" id="igo_loan_1" /></div> 
                                    </td>
                                    <td>
                                      <div class="form-group"><input type="text" class="form-control required" name="tg_bond[]" id="tg_bond_1" /></div> 
                                    </td>
   ...
   $('#dynamic_add').click(function(){
        if(x < count){
            ...
            $('#table').append('<tr id="row_' + x + '">'
              ...
              +'<td><div class="form-group"><select class="form-control" id="sanction_block_id_' + x + '" name="sanction_block_id[]" required ><option value="">Select</option>'
              +'<?php if($block_list){
                  foreach($block_list as $block){
                    echo '<option value="'.$block->block_code.'">'.$block->block_name.'</option>';
                  }
              ...
              +'</select></div></td>'
              +'<td><div class="form-group"><input type="text" class="form-control required" name="sanction_working[]" id="sanction_working_' + x + '" /></div></td>'
              +'<td><div class="form-group"><input type="text" class="form-control required" name="sanction_total[]" id="sanction_total_' + x + '" /></div></td>'
              +'<td><div class="form-group"><select class="form-control" id="disbursement_block_id_' + x + '" name="disbursement_block_id[]" required ><option value="">Select</option>'
              +'<?php if($block_list){
                  foreach($block_list as $block){
                    echo '<option value="'.$block->block_code.'">'.$block->block_name.'</option>';
                  }
              ...
              +'</select></div></td>'
              +'<td><div class="form-group"><input type="text" class="form-control required" name="disbursement_working[]" id="disbursement_working_' + x + '" /></div></td>'
              +'<td><div class="form-group"><input type="text" class="form-control required" name="disbursement_total[]" id="disbursement_total_' + x + '" /></div></td>'

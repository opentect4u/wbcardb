...
<div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">DC Self Approve
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       <?php foreach($shg_details as $dt){
                                ...
                                echo '<td>
                                        <a href="dc_self_forward/dc_entry/'.$pronote_no.'/'.$memo_no.'" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil fa-lg"></i></a>';
                                    // if($dt->fwd_data == 'N'){
                                  ...
                                  if($dt->upload > 0){
                                    echo '<td>
                                        ...
                                        if($dt->fwd_data == 'N'){
                                    echo '<td>
                                      <a href="dc_self_forward/forward_data/'.$pronote_no.'/'.$memo_no.'" data-toggle="tooltip" data-placement="bottom" title="Forward Data"><i class="fa fa-forward fa-lg"></i></a>
                                      </td>';
                                    }else{
                                      echo '<td></td>';
                                    }

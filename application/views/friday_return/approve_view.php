                                ...
                                <tbody>
                                    ...
                                    if ($friday_details) {
                                        ...
                                        foreach ($friday_details as $dt) {
                                            ...
                                            echo '<td>' . $status . '</td>';
                                            echo '<td><a href="view_details/' . $dt->ardb_id . '?dt=' . $dt->week_dt . '" data-toggle="tooltip" data-placement="bottom" title="View"><i class="fa fa-eye fa-lg" aria-hidden="true"></i></a></td>';

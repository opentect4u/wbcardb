...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">DC View <small>SHG</small><small><a href="<?php echo site_url("dc/dc_entry/0/0"); ?>" class="btn btn-primary bttn-ad" style="width: 100px;">Add</a></small>
                ...
                <div class="row">
					...
					//if($dt->upload > 0){
					// echo '<td>
					//     <a href="download_zip/'.$ardb_id.'/'.$pronote_no.'" data-toggle="tooltip" data-placement="bottom" title="Download"><i class="fa fa-download fa-lg"></i></a>
					//     </td>';
					//     if($dt->fwd_data == 'N'){
					// echo '<td>

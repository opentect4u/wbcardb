...
class Report extends CI_Controller{
    ...
    public function friday_ho(){                    /**Opening Stock report for every year */
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $this->load->view('report/friday_rtn/friday_out.php',$data);
            ...
            $this->load->view('report/friday_rtn/friday_inp.php');
    ...
    public function friday_ardb(){ 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $this->load->view('report/friday_rtn/fridayardb_out.php',$data);
            ...
            $this->load->view('report/friday_rtn/fridayardb_inp.php',$data);
    ...
    public function borrower_ho(){ 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $this->load->view('report/borrower/borrower_out.php',$data);
          ...
          //  $data['branch'] = $this->Master->get_particulars("mm_ardb_ho",NULL,NULL,0);
            ...
            $this->load->view('report/borrower/borrower_inp.php');
    ...
    public function borrower_ardb(){ 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $this->load->view('report/borrower/borrowerardb_out.php',$data);
            ...
            $this->load->view('report/borrower/borrowerardb_inp.php',$data);
    ...
    public function investment_ho(){ 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $this->load->view('report/investment/investment_out.php',$data);
            ...
            $this->load->view('report/investment/investment_inp.php');
    ...
    public function investment_ardb(){ 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $this->load->view('report/investment/investmentardb_out.php',$data);
            ...
            $this->load->view('report/investment/investmentardb_inp.php',$data);
     ...
     public function fortnightly_ho(){ 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $this->load->view('report/fortnight/fortnightly_out.php',$data);
            ...
            $this->load->view('report/fortnight/fortnightly_inp.php',$data);
    ...
    public function fortnightly_ardb(){ 
        ...
        if($_SERVER['REQUEST_METHOD']=='POST'){
            ...
            $this->load->view('report/fortnight/fortnightlyardb_out.php',$data);
            ...
            $this->load->view('report/fortnight/fortnightlyardb_inp.php',$data);

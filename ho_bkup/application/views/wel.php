    ...
    <div class="container-fluid page-body-wrapper">------
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <!-- href="pages/widgets/widgets.html">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#charts" aria-expanded="false" aria-controls="charts">
              ...
              <span class="menu-title">User Maintainance</span>
              <i class="menu-arrow"></i>
            </a>
              ...
              <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    ...
                    <canvas id="users-chart-dark"></canvas>
                  </div>
                </div>
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    ...
                    <canvas id="projects-chart-dark"></canvas>
                  </div>
                </div>
              </div>
              <div class="row">
                      ...
                      <div class="row mt-4">
                        <div class="col-md-6 stretch-card">
                          <div class="row d-flex align-items-center">
                            <div class="col-6">
                              <div id="offlineProgressDark"></div>                              
                            </div>
            ...
            <div class="col-xl-3 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <button class="btn btn-outline-light d-block mx-auto mt-2">View More</button>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-md-7 col-lg-6 col-xl-7">
                    <div class="card-body h-100 d-flex flex-column">
                      ...
                      <canvas id="sale-report-chart-dark"></canvas>
                    </div>
                  </div>
                  <div class="col-md-5 col-lg-6 col-xl-5">
                    <div class="card-body">
                      ...
                      <div class="d-flex mb-3">
                        ...
                        <p class="mb-0">15% more than last week</p>
                      </div>
                      <div class="d-flex flex-wrap mb-5">
                        <button class="btn btn-info mt-3 mr-2">Update</button>
                        <button class="btn btn-outline-light mt-3">View more</button>
                      </div>                  
                    </div>
                  </div>
                </div>

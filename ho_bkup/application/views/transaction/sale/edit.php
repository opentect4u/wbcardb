    ...
    <div class="col-12 grid-margin" style="padding:0px;">
                <div class="card">
                  <div class="card-body">
                    <h4>New Purchase</h4>
                    <br><br>
                    <form class="form-sample" method="POST" action="<?php echo site_url('Purchases/editPurchase'); ?>">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Invoice Date</label>
                            <div class="col-sm-9">
                              <input type="date" class="form-control" name="bill_dt" value="<?php echo $row1->bill_dt; ?>" readonly/>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <select class="livesearch" id="comp_name" name="comp_name">
                              <option value="0">Select Company</option>
                              <?php foreach($companys as $row) { ?>
                                <option value="<?php echo $row->ID;?>"
                                               <?php  echo($row->ID == $row1->comp)?'selected':'';?>><?php echo $row->Comp_Name;?>
                                </option>
                                <?php
                                  }
                                ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <select class="livesearch" id="bill_type" name="bill_type">
                              <option value="0">Select Bill Type</option>
                              <option value="C"<?php echo($row1->bill_type=='C')?'selected':''; ?>>Cash</option>
                              <option value="B"<?php echo($row1->bill_type=='B')?'selected':''; ?>>Credit</option>
                            </select>
                            </div>
                          </div>
                        </div>
                          ...
                          <tbody id="intro">
                            ...
                            <tr>
                              <td><select class="livesearch" style="width:200px" name="Pro_ID[]" id=Pro_ID>
                                  ...
                                  <option value="<?php echo $row->ID?>"
                                                 <?php echo ($row->ID==$val->pro_id)?'selected':'';?>><?php echo $row->Name?>
                                  </option>
                                  <?php
                                    }
                                  ?>
                              ...
                              <td><input type="text" class="form-control"   style="width:200px"  name="Batch[]" id="Batch" value="<?php echo $val->batch;?>"readonly readonly/></td>     
                              <td><input type="text" class="form-control"   style="width:90px"   name="Unit[]" id="unit" value="<?php echo $val->unit;?>"required readonly/></td>                
                              <td><input type="date" class="form-control"   style="width:200px"  name="Expiry[]" value="<?php echo $val->exp_dt;?>"required /></td>
                              ...
                              <td><input type="text" class="form-control"   style="width:90px" name="Qty[]" id="qty" value="<?php echo $val->qty;?>" required/></td>
